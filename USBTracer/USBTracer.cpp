...
CollectTraceHub ( kd_buf tracepoint ) 
{
	...
	switch ( type )
	{
		...
		case USB_HUB_TRACE( kTPHubCheckForDeadDevice ):
			...
			{			   
                log(info, "Hub", "CheckForDeadHub", parg1, "device(%u) has been unplugged", arg2); // PHT was "device(%u) ..." (void *) arg2);

			}
			else if ( arg4 == 9)
			{			   
			// PHT	log(info, "Hub", "CheckForDeadHub", parg1, "no hubInterface (%p), device(%p), or pipe", (void*)arg2, (void*)arg3);
                log(info, "Hub", "CheckForDeadHub", parg1, "no hubInterface (%u), device(%u), or pipe", arg2, arg3);    // PHT
			}
			else if ( arg4 == 10)
			{			   
...
CollectTraceInterfaceUserClient	( kd_buf tracepoint ) 
{
	...
	switch ( type )
	{
		...
		case USB_INTERFACE_UC_TRACE( kTPInterfaceUCIsoReqComplete ):
			log(info, "InterfaceUserClient", "IsoReqComplete", parg1, "Error: 0x%x, FrameListPtr: %u", arg2, arg3 );  // PHT was %p" (void*) arg3
			break;
			
		case USB_INTERFACE_UC_TRACE( kTPInterfaceUCLLIsoReqComplete ):
			log(info, "InterfaceUserClient", "LL IsoReqComplete", parg1, "Error: 0x%x, FrameListPtr: %u", arg2, arg3 ); // PHT was %p" (void*) arg3
			break;
        ...
        case USB_XHCI_TRACE(kTPXHCIQuiesceEndpoint):
			{
				...
				{
// PHT timeNano unused				uint64_t	timeNano = info.timestamp - startTime;
        ...
        case USB_XHCI_TRACE(kTPXHCIAsyncEPCreateTD):
            {
                if (qualifier == DBG_FUNC_START)
                {
                   log (info, "XHCI", "AsyncEPCreateTD", parg1, "USBCommand: %u totalTransferSize: %d offC: 0x%x", arg2, arg3, arg4);// PHT was %p (void*)
                }
                else if (qualifier == DBG_FUNC_END)
                {
        ...
        case USB_XHCI_TRACE(kTPXHCIAsyncEPScheduleTD):
            {
                ...
                {
                    log (info, "XHCI", "AsyncEPScheduleTD", parg1, "ReadyATD: %u USBCommand: %u CompletionIndex: %d", arg2, arg3, arg4);  // PHT was %p %p (void*)arg2, (void*)arg3
                }
            }
            break;
        ...
        case USB_XHCI_TRACE(kTPXHCIAsyncEPScavengeTD):
            {
                ...
                {
                    log (info, "XHCI", "AsyncEPScavengeTD", parg1, "ActiveATD: %u USBCommand: %u", arg2, arg3);  // PHT was %p %p (void*)arg2, (void*)arg3
        ...
        case USB_XHCI_TRACE(kTPXHCIAsyncEPUpdateTimeout):
            {
                ...
                {
                    log (info, "XHCI", "AsyncEPUpdateTimeout", parg1, "USBCommand: %u noDataTimeout: %d time: %d", arg2, arg3, arg4); // PHT was %p (void*)arg2

                }
                else
                {
                    log (info, "XHCI", "AsyncEPUpdateTimeout", parg1, "ActiveATD: %u returnATransfer: %d", arg2, arg3); // PHT was %p (void*)arg2
        ...
        case USB_XHCI_TRACE(kTPXHCIAsyncEPAbort):
            {
                ...
                {
                    log (info, "XHCI", "AsyncEPAbort", parg1, "ActiveATD: %u USBCommand: %u CompletionIndex: %d", arg2, arg3, arg4); // PHT was %p %p (void*)arg2, (void*)arg3
        ...
        case USB_XHCI_TRACE(kTPXHCIAsyncEPComplete):
            {
                ...
                {
                    log (info, "XHCI", "AsyncEPComplete", parg1, "DoneATD: %u USBCommand: %u CompletionIndex: %d", arg2, arg3, arg4); // PHT was %p %p (void*)arg2, (void*)arg3
        ...
        case USB_XHCI_TRACE(kTPXHCIWaitForCmd):
		{
			if (qualifier == DBG_FUNC_START)
			{
                log (info, "XHCI", "WaitForCMD", parg1, "TRB: %u, command: %d", arg2, arg3); // PHT was %p (void*)arg2

			}
			else if (qualifier == DBG_FUNC_END)
			{
                log (info, "XHCI", "WaitForCMD", parg1, "TRB: %u, returning 0x%x", arg2, arg3); // PHT was %p (void*)arg2
